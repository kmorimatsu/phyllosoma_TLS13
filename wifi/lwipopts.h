...
#undef MEM_SIZE
#define MEM_SIZE    (105 * 1024)
#define ALTCP_MBEDTLS_PRIVATE_MEM             0
#define ALTCP_MBEDTLS_MEM_NUM_CONTEXTS        1
#undef ALTCP_MBEDTLS_PRIVATE_MEM_SIZE
#define ALTCP_MBEDTLS_PRIVATE_MEM_SIZE    (75 * 1024)
#define ALTCP_MBEDTLS_MEM_INITIAL_ALLOC_SIZE   (48 * 1024)
